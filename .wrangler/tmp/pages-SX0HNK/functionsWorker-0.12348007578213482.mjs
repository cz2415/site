...
async function onRequestGet(context) {
  ...
  const dailyRows = days.length ? days.map(
    (d) => `<tr><td>${d.day}</td><td>${d.portable}</td><td>${d.setup}</td><td>${d.portable + d.setup}</td></tr>`
  ).join("") : '<tr><td colspan="4" class="empty">\u8FD8\u6CA1\u6709\u4E0B\u8F7D\u8BB0\u5F55</td></tr>';
  const list = /* @__PURE__ */ __name((obj) => Object.entries(obj).sort((a, b) => b[1] - a[1]).map(([k, v]) => `<li><b>${esc(k)}</b><span>${v}</span></li>`).join("") || '<li class="empty">\u2014</li>', "list");
  const body = `
...
<title>\u4E0B\u8F7D\u7EDF\u8BA1 \xB7 Scratch Pad</title>
<style>
...
// d/[[file]].js
var TARGETS = {
  portable: "https://github.com/cz2415/scratch-pad-app/releases/latest/download/Scratch-Pad-x64-portable.exe",
  setup: "https://github.com/cz2415/scratch-pad-app/releases/latest/download/Scratch-Pad-x64-setup.exe"
};
...
async function countDownload({ env, request }, kind) {
  ...
  record.last = (/* @__PURE__ */ new Date()).toISOString();
  await kv.put(key, JSON.stringify(record));
}
__name(countDownload, "countDownload");
...
__name(osFrom, "osFrom");

// ../.wrangler/tmp/pages-SX0HNK/functionsRoutes-0.09574572059232567.mjs
var routes = [
  {
    routePath: "/d/stats",
    mountPath: "/d",
...
// C:/Users/cz2415/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/cz2415/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/cz2415/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/cz2415/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-jJyY0K/middleware-insertion-facade.js
...
// C:/Users/cz2415/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-jJyY0K/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.12348007578213482.mjs.map
