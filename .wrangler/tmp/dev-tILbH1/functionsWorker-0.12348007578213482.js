...
// .wrangler/tmp/pages-SX0HNK/functionsWorker-0.12348007578213482.mjs
...
async function onRequestGet(context) {
  ...
  const list = /* @__PURE__ */ __name2((obj) => Object.entries(obj).sort((a, b) => b[1] - a[1]).map(([k, v]) => `<li><b>${esc(k)}</b><span>${v}</span></li>`).join("") || '<li class="empty">\u2014</li>', "list");
  const body = `
...
__name2(countDownload, "countDownload");
...
// .wrangler/tmp/bundle-scFiaJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-scFiaJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.12348007578213482.js.map
